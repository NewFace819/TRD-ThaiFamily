...
\teamnote{University of Science, VNUHCM}{HCMUS - ThaiFamily}{Le Kien Thanh, Vo Thanh Hai, Do Gia Huy}
...
\Algorithm{Min Plus Convolution}
{}{}
{cpp}{source/Misc/MinPlusconvolution.cpp}

% Thay dòng \Algorithm bị lỗi bằng dòng này:
\subsection{Mathematics} % Hoặc \subsection tùy cấp độ bạn muốn
\input{source/Misc/Mathematics.tex}
...
{}{}
{cpp}{source/Graph/DominatorTree.cpp}
...
\input{source/Graph/FlowModel.tex}
...
\Algorithm{Dirchlet Convolution}
{}{}
{cpp}{source/Arithmetic/DirchletConv.cpp}
...
\Algorithm{Pythagorean Triples}
{}{}
{cpp}{source/Arithmetic/Pythagorean_Triples.cpp}
...
\Algorithm{Sqrt Mod}
{}{}
{cpp}{source/Arithmetic/SqrtMod.cpp}

\Algorithm{Super Eratosthene}
{}{}
{cpp}{source/Arithmetic/Super_Ultra_Eratosthene.cpp}
